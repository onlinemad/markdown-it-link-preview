...
it('get link preview html', () => {
  ...
  expect(result).toMatch(
      '<p><div class="card ms-md-5 me-md-5 lp-card"><img src="https://repository-images.githubusercontent.com/292775522/57a0a600-f246-11ea-9b1a-078a5abb05e8" class="card-img-top lp-img-top" alt="junkawa/figma_jp" loading="lazy"><div class="card-body"><h5 class="card-title text-truncate lp-title"><a href="https://github.com/junkawa/figma_jp" target="_blank">junkawa/figma_jp</a></h5><p class="card-text m-0 lh-sm lp-desc"><small>Japanese Chrome Extension for figma. Contribute to junkawa/figma_jp development by creating an account on GitHub.</small></p><p class="card-text lp-url"><small class="text-muted">https://github.com/junkawa/figma_jp</small></p></div></div></p>',
  );
